...
# Install anaconda3 (approx. 5 mins)
...
# Creating a conda environment (20 mins)
...
```{bash, eval=FALSE}
conda create --name albacore_env python=3.6 anaconda
```

---

# Installing albacore into the conda environment 
...
pip install ont_albacore-1.2.6-cp36-cp36m-macosx_10_11_x86_64.whl
...
Now let's use conda to install some tools.
...
# Pauvre
Used to produce yield and length distribution plots
```{bash, eval=FALSE}
